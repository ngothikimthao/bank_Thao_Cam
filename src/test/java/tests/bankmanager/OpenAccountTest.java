...
public class OpenAccountTest {
    ...
    public void verifyOpenCustomerSuccessfully(String firstname, String lastname) throws InterruptedException {
        Thread.sleep(1000);
        getOpenAccountPage().verifyOpenAccountSuccessfullyWithPopup(getOpenAccountPopup);
        Thread.sleep(1000);
    ...
    public void verifyOpenAccountUnsuccessfullyWithoutCurrency() throws InterruptedException {
        Thread.sleep(1000);
        getOpenAccountPage().verifyOpenAccountUnsuccessfullyWithPopup(getOpenAccountPopup);
        Thread.sleep(1000);
    }
}
